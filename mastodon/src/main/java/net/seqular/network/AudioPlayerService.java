...
public class AudioPlayerService extends Service{
	...
	private static final String ACTION_PLAY_PAUSE="net.seqular.android.AUDIO_PLAY_PAUSE";
	private static final String ACTION_STOP="net.seqular.android.AUDIO_STOP";
